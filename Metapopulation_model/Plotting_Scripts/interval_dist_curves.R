...
# d<-density(log(unlist(oneVillage64000_extInt)),na.rm=TRUE)
# plot(d,xlim=c(-5,5))
# d1<-density(log(unlist(twoVillage32000_extInt)),na.rm=TRUE)
# lines(d1,col='red')
# d2<-density(log(unlist(fourVillage16000_extInt)),na.rm=TRUE)
# lines(d2,col='blue')
# d3<-density(log(unlist(eightVillage8000_extInt)),na.rm=TRUE)
# lines(d3,col='green')
# d4<-density(log(unlist(sixteenVillage4000_extInt)),na.rm=TRUE)
# lines(d4,col='purple')
# d5<-density(log(unlist(thirtytwoVillage2000_extInt)),na.rm=TRUE)
# lines(d5,col='orange')
...
# png(paste0(dir2,"extInt_dist_noMig_positive_zoom.png"), width=1400, height=800, res=150) 
...
twoVillage32000_TBP_migRate_0.2 = read.csv(paste0(dir5,"time_between_pcases_3200032000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(900)), fill = TRUE)
twoVillage32000_extInt_migRate_0.2 = read.table(paste0(dir5,"extinction_interval_3200032000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"))
fourVillage16000_TBP_migRate_0.2 = read.csv(paste0(dir5,"time_between_pcases_16000160001600016000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(1070)), fill = TRUE)
fourVillage16000_extInt_migRate_0.2 = read.table(paste0(dir5,"extinction_interval_16000160001600016000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"))
eightVillage8000_TBP_migRate_0.2 = read.csv(paste0(dir5,"time_between_pcases_80008000800080008000800080008000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(280)), fill = TRUE)
eightVillage8000_extInt_migRate_0.2 = read.table(paste0(dir5,"extinction_interval_80008000800080008000800080008000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"))
sixteenVillage4000_TBP_migRate_0.2 = read.csv(paste0(dir5,"time_between_pcases_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
sixteenVillage4000_extInt_migRate_0.2 = read.table(paste0(dir5,"extinction_interval_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"))
thirtytwoVillage2000_TBP_migRate_0.2 = read.csv(paste0(dir5,"time_between_pcases_20002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
thirtytwoVillage2000_extInt_migRate_0.2 = read.table(paste0(dir5,"extinction_interval_32x2000_reintRate_0.001000migRate_0.200000_seasonality_period_1yr_1pcase.csv"))

#remove nas
new <- unlist(oneVillage64000_extInt)[!is.na(unlist(oneVillage64000_extInt))]
new1<-unlist(twoVillage32000_extInt_migRate_0.2)[!is.na(unlist(twoVillage32000_extInt_migRate_0.2))]
new2<-unlist(fourVillage16000_extInt_migRate_0.2)[!is.na(unlist(fourVillage16000_extInt_migRate_0.2))]
new3<-unlist(eightVillage8000_extInt_migRate_0.2)[!is.na(unlist(eightVillage8000_extInt_migRate_0.2))]
new4<-unlist(sixteenVillage4000_extInt_migRate_0.2)[!is.na(unlist(sixteenVillage4000_extInt_migRate_0.2))]
new5<-unlist(thirtytwoVillage2000_extInt_migRate_0.2)[!is.na(unlist(thirtytwoVillage2000_extInt_migRate_0.2))]
...
#plot smooth curves on top of each other
png(paste0(dir2,"extInt_dist_migRate_0.2_positive.png"), width=1400, height=800, res=150) 
plot((k$eval.points),k$estimate,col='black',type='l',ylim=c(0,1),xlim=c(0,6),xlab='Length of extinction interval (Years)',ylab='Density',main="Migration 0.2")
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
lines((k5$eval.points),k5$estimate,col=marker$color[8])
legend('topright',legend=c('1 village (1x64000)','2 villages (2x32000)','4 villages (4x16000)','8 villages (8x8000)','16 villages (16x4000)','32 villages (32x2000)'),col=c('black',marker$color[4:8]),lwd=2,bty='n')
dev.off()

png(paste0(dir2,"extInt_dist_migRate_0.2_positive_zoom.png"), width=1400, height=800, res=150) 
plot((k$eval.points),k$estimate,col='black',type='l',ylim=c(0,0.1),xlim=c(2,4),xlab='Length of extinction interval (Years)',ylab='Density',main="Migration 0.2")
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
...
new <- unlist(oneVillage64000_TBP)[!is.na(unlist(oneVillage64000_TBP))]
new1<-unlist(twoVillage32000_TBP_migRate_0.2)[!is.na(unlist(twoVillage32000_TBP_migRate_0.2))]
new2<-unlist(fourVillage16000_TBP_migRate_0.2)[!is.na(unlist(fourVillage16000_TBP_migRate_0.2))]
new3<-unlist(eightVillage8000_TBP_migRate_0.2)[!is.na(unlist(eightVillage8000_TBP_migRate_0.2))]
new4<-unlist(sixteenVillage4000_TBP_migRate_0.2)[!is.na(unlist(sixteenVillage4000_TBP_migRate_0.2))]
new5<-unlist(thirtytwoVillage2000_TBP_migRate_0.2)[!is.na(unlist(thirtytwoVillage2000_TBP_migRate_0.2))]
...
marker = list(color = brewer.pal(8,"YlOrRd"))
#plot smooth curves on top of each other
png(paste0(dir2,"intercase_dist_migRate_0.2_positive.png"), width=1400, height=800, res=150) 
plot(k$eval.points,k$estimate,col='black',type='l',ylim=c(0,1.5),xlim=c(0,6),xlab='Length of intercase interval (Years)',ylab='Density',main="Migration 0.2")
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
...
png(paste0(dir2,"intercase_dist_migRate_0.2_positive_zoom.png"), width=1400, height=800, res=150) 
plot(k$eval.points,k$estimate,col='black',type='l',ylim=c(0,0.01),xlim=c(2,4),xlab='Length of intercase interval (Years)',ylab='Density',main="Migration 0.2")
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
...
##version 2 did not use for paper

oneVillage64000_TBP_v2 = read.csv(paste0(dir5,"time_between_pcases_64000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_ES_test.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(1099)), fill = TRUE)
oneVillage64000_extInt_v2 = read.table(paste0(dir5,"extinction_interval_64000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_ES_test.csv"))
twoVillage32000_TBP_v2 = read.csv(paste0(dir3,"time_between_pcases_3200032000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
twoVillage32000_extInt_v2 = read.table(paste0(dir3,"extinction_interval_3200032000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"))
fourVillage16000_TBP_v2 = read.csv(paste0(dir5,"time_between_pcases_16000160001600016000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_ES_test.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
fourVillage16000_extInt_v2 = read.table(paste0(dir5,"extinction_interval_16000160001600016000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_ES_test.csv"))
eightVillage8000_TBP_v2 = read.csv(paste0(dir3,"time_between_pcases_80008000800080008000800080008000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
eightVillage8000_extInt_v2 = read.table(paste0(dir3,"extinction_interval_80008000800080008000800080008000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"))
sixteenVillage4000_TBP_v2 = read.csv(paste0(dir3,"time_between_pcases_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
sixteenVillage4000_extInt_v2 = read.table(paste0(dir3,"extinction_interval_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"))
thirtytwoVillage2000_TBP_v2 = read.csv(paste0(dir3,"time_between_pcases_20002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000200020002000reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(180)), fill = TRUE)
thirtytwoVillage2000_extInt_v2 = read.table(paste0(dir3,"extinction_interval_32x2000_reintRate_0.001000migRate_0.000000_seasonality_period_1yr_1pcase_v2.csv"))

#remove nas
new <- unlist(oneVillage64000_extInt_v2)[!is.na(unlist(oneVillage64000_extInt_v2))]
new1<-unlist(twoVillage32000_extInt_v2)[!is.na(unlist(twoVillage32000_extInt_v2))]
new2<-unlist(fourVillage16000_extInt_v2)[!is.na(unlist(fourVillage16000_extInt_v2))]
new3<-unlist(eightVillage8000_extInt_v2)[!is.na(unlist(eightVillage8000_extInt_v2))]
new4<-unlist(sixteenVillage4000_extInt_v2)[!is.na(unlist(sixteenVillage4000_extInt_v2))]
new5<-unlist(thirtytwoVillage2000_extInt_v2)[!is.na(unlist(thirtytwoVillage2000_extInt_v2))]
...
marker = list(color = brewer.pal(8,"YlOrRd"))
#plot smooth curves on top of each other
png(paste0(dir2,"extInt_dist_noMig_positive_zoom_paper_v2.png"), width=1400, height=800, res=150) 
par(mfrow=c(1,2),mar=c(4,2,2,2),oma=c(3,4,3,3),mgp=c(3,1,0))
plot(k$eval.points,k$estimate,col='black',type='l',ylim=c(0,1.5),xlim=c(0,6),xlab='',ylab='')
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
lines((k5$eval.points),k5$estimate,col=marker$color[8])
legend('topright',legend=c('1 village (1x64000)','2 villages (2x32000)','4 villages (4x16000)','8 villages (8x8000)','16 villages (16x4000)','32 villages (32x2000)'),col=c('black',marker$color[4:8]),lwd=2,bty='n')
plot(k$eval.points,k$estimate,col='black',type='l',ylim=c(0,0.2),xlim=c(2,4),xlab='',ylab='')
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
lines((k5$eval.points),k5$estimate,col=marker$color[8])
mtext('Length of extinction interval (Years)',side=1,line=1,outer=TRUE)
mtext("Density",side=2,line=1,outer=TRUE)
mtext('V2',side=3,line=1,outer=TRUE)
dev.off()

new <- unlist(oneVillage64000_TBP_v2)[!is.na(unlist(oneVillage64000_TBP_v2))]
new1<-unlist(twoVillage32000_TBP_v2)[!is.na(unlist(twoVillage32000_TBP_v2))]
new2<-unlist(fourVillage16000_TBP_v2)[!is.na(unlist(fourVillage16000_TBP_v2))]
new3<-unlist(eightVillage8000_TBP_v2)[!is.na(unlist(eightVillage8000_TBP_v2))]
new4<-unlist(sixteenVillage4000_TBP_v2)[!is.na(unlist(sixteenVillage4000_TBP_v2))]
new5<-unlist(thirtytwoVillage2000_TBP_v2)[!is.na(unlist(thirtytwoVillage2000_TBP_v2))]
...
png(paste0(dir2,"intercase_dist_noMig_positive_zoom_paper_v2.png"), width=1400, height=800, res=150) 
par(mfrow=c(1,2),mar=c(4,2,2,2),oma=c(3,4,3,3),mgp=c(3,1,0))
plot(k$eval.points,k$estimate,col='black',type='l',ylim=c(0,1.5),xlim=c(0,6),xlab='',ylab='')
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
...
lines((k5$eval.points),k5$estimate,col=marker$color[8])
legend('topright',legend=c('1 village (1x64000)','2 villages (2x32000)','4 villages (4x16000)','8 villages (8x8000)','16 villages (16x4000)','32 villages (32x2000)'),col=c('black',marker$color[4:8]),lwd=2,bty='n')
plot(k$eval.points,k$estimate,col='black',type='l',ylim=c(0,0.06),xlim=c(2,4),xlab='',ylab='')
lines((k1$eval.points),k1$estimate,col=marker$color[4])
lines((k2$eval.points),k2$estimate,col=marker$color[5])
lines((k3$eval.points),k3$estimate,col=marker$color[6])
lines((k4$eval.points),k4$estimate,col=marker$color[7])
lines((k5$eval.points),k5$estimate,col=marker$color[8])
mtext('Length of intercase interval (Years)',side=1,line=1,outer=TRUE)
mtext("Density",side=2,line=1,outer=TRUE)
mtext('V2',side=3,line=1,outer=TRUE)
dev.off()
par(mfrow=c(1,1))
hist(new,freq=FALSE,col=rgb(0.1,0.1,0.1,0.5))
hist(new1,freq=FALSE,col=rgb(0.2,0.2,0.2,0.5))
hist(new2,freq=FALSE,col=rgb(0.3,0.3,0.3,0.5))
hist(new3,freq=FALSE,col=rgb(0.4,0.4,0.4,0.5))
hist(new4,freq=FALSE,col=rgb(0.5,0.5,0.5,0.5))
hist(new5,freq=FALSE,col=rgb(0.6,0.6,0.6,0.5))

hist(new3,freq=FALSE,col=rgb(0.1,0.1,0.1,0.5),xlim=c(2,4),ylim=c(0,0.2))
hist(new2,freq=FALSE,col=rgb(0.8,0.8,0.8,0.5),add=TRUE,xlim=c(2,4),ylim=c(0,0.2))
...
## test figs for testing movement
fourVillage16000_TBP_0.05 = read.csv(paste0(dir4,"time_between_pcases_16000160001600016000reintRate_0.001000migRate_0.050000_paper.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(1000)), fill = TRUE)
fourVillage16000_extInt_0.05 = read.table(paste0(dir4,"extinction_interval_16000160001600016000reintRate_0.001000migRate_0.050000_paper.csv"))
fourVillage16000_TBP_0.2 = read.csv(paste0(dir4,"time_between_pcases_16000160001600016000reintRate_0.001000migRate_0.200000_paper.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(1000)), fill = TRUE)
fourVillage16000_extInt_0.2 = read.table(paste0(dir4,"extinction_interval_16000160001600016000reintRate_0.001000migRate_0.200000_paper.csv"))
fourVillage16000_TBP_1 = read.csv(paste0(dir4,"time_between_pcases_16000160001600016000reintRate_0.001000migRate_1.000000_paper.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(4000)), fill = TRUE)
fourVillage16000_extInt_1 = read.table(paste0(dir4,"extinction_interval_16000160001600016000reintRate_0.001000migRate_1.000000_paper.csv"))

#remove nas
new <- unlist(fourVillage16000_extInt)[!is.na(unlist(fourVillage16000_extInt))]
new1<-unlist(fourVillage16000_extInt_0.05)[!is.na(unlist(fourVillage16000_extInt_0.05))]
new2<-unlist(fourVillage16000_extInt_migRate_0.1)[!is.na(unlist(fourVillage16000_extInt_migRate_0.1))]
new3<-unlist(fourVillage16000_extInt_0.2)[!is.na(unlist(fourVillage16000_extInt_0.2))]
new4<-unlist(fourVillage16000_extInt_1)[!is.na(unlist(fourVillage16000_extInt_1))]
...
marker = list(color = brewer.pal(8,"YlOrRd"))
#plot smooth curves on top of each other
png(paste0(dir2,"extInt_dist_4x16000_comp_move.png"), width=1400, height=800, res=150) 
par(mfrow=c(1,2),mar=c(4,2,2,2),oma=c(3,4,3,3),mgp=c(3,1,0))
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,1),xlim=c(0,6),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
lines((k3$eval.points),k3$estimate,col=marker$color[6],lwd=2)
lines((k4$eval.points),k4$estimate,col=marker$color[7],lwd=2)
legend('topright',legend=c('Movement rate = 0','Movement rate = 0.05','Movement rate = 0.1','Movement rate = 0.2','Movement rate = 1'),col=marker$color[3:7],lwd=2,bty='n')
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,0.02),xlim=c(3,5),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
lines((k3$eval.points),k3$estimate,col=marker$color[6],lwd=2)
lines((k4$eval.points),k4$estimate,col=marker$color[7],lwd=2)
...
new_vec<-list(new,new1,new2,new3,new4)
num_cats = 5
png(paste0(dir2,"num_extInts_4x16000_comp_move_v2_zoom.png"), width=1400, height=800, res=150) 
for(i in 1:length(new_vec)){
  data = new_vec[[i]]
  sum_vec<-c()
  for(j in 1:num_cats){
    sum_vec[j] = sum(data>=j)
  }
  if(i == 1){
    plot(sum_vec,type='l',col=marker$color[i+2],lwd=2,xlab='Years since case',ylab='Number of extinction intervals',ylim=c(0,2000))
  }
  else{
    lines(sum_vec,col=marker$color[i+2],lwd=2)
  }
}
legend('topright',legend=c('Movement rate = 0','Movement rate = 0.05','Movement rate = 0.1','Movement rate = 0.2','Movement rate = 1'),col=marker$color[3:7],lwd=2,bty='n')
dev.off()
...
#remove nas
new <- unlist(fourVillage16000_TBP)[!is.na(unlist(fourVillage16000_TBP))]
new1<-unlist(fourVillage16000_TBP_0.05)[!is.na(unlist(fourVillage16000_TBP_0.05))]
new2<-unlist(fourVillage16000_TBP_migRate_0.1)[!is.na(unlist(fourVillage16000_TBP_migRate_0.1))]
new3<-unlist(fourVillage16000_TBP_0.2)[!is.na(unlist(fourVillage16000_TBP_0.2))]
new4<-unlist(fourVillage16000_TBP_1)[!is.na(unlist(fourVillage16000_TBP_1))]
...
marker = list(color = brewer.pal(8,"YlOrRd"))
#plot smooth curves on top of each other
png(paste0(dir2,"interInt_dist_4x16000_comp_move.png"), width=1400, height=800, res=150) 
par(mfrow=c(1,2),mar=c(4,2,2,2),oma=c(3,4,3,3),mgp=c(3,1,0))
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,1),xlim=c(0,6),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
...
lines((k4$eval.points),k4$estimate,col=marker$color[7],lwd=2)
legend('topright',legend=c('Movement rate = 0','Movement rate = 0.05','Movement rate = 0.1','Movement rate = 0.2','Movement rate = 1'),col=marker$color[3:7],lwd=2,bty='n')
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,0.008),xlim=c(3,5),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
lines((k3$eval.points),k3$estimate,col=marker$color[6],lwd=2)
lines((k4$eval.points),k4$estimate,col=marker$color[7],lwd=2)
...
new_vec<-list(new,new1,new2,new3,new4)
num_cats = 5
png(paste0(dir2,"num_interInts_4x16000_comp_move_v2_zoom.png"), width=1400, height=800, res=150) 
for(i in 1:length(new_vec)){
  data = new_vec[[i]]
  sum_vec<-c()
  for(j in 1:num_cats){
  ...
  if(i == 1){
    plot(sum_vec,type='l',col=marker$color[i+2],lwd=2,xlab='Years since case',ylab='Number of intercase intervals',ylim=c(0,8000))
  }
  else{
    lines(sum_vec,col=marker$color[i+2],lwd=2)
  }
...
sixteenVillage4000_TBP_0.05 = read.csv(paste0(dir4,"time_between_pcases_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.050000_paper.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(500)), fill = TRUE)
sixteenVillage4000_extInt_0.05 = read.table(paste0(dir4,"extinction_interval_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.050000_paper.csv"))
sixteenVillage4000_TBP_0.2 = read.csv(paste0(dir4,"time_between_pcases_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.200000_paper.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(1000)), fill = TRUE)
sixteenVillage4000_extInt_0.2 = read.table(paste0(dir4,"extinction_interval_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_0.200000_paper.csv"))
sixteenVillage4000_TBP_1 = read.csv(paste0(dir4,"time_between_pcases_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_1.000000_paper.csv"),sep=",",header = FALSE,col.names = paste0("V",seq_len(4000)), fill = TRUE)
sixteenVillage4000_extInt_1 = read.table(paste0(dir4,"extinction_interval_4000400040004000400040004000400040004000400040004000400040004000reintRate_0.001000migRate_1.000000_paper.csv"))

#remove nas

new <- unlist(sixteenVillage4000_extInt)[!is.na(unlist(sixteenVillage4000_extInt))]
new1<-unlist(sixteenVillage4000_extInt_0.05)[!is.na(unlist(sixteenVillage4000_extInt_0.05))]
new2<-unlist(sixteenVillage4000_extInt_migRate_0.1)[!is.na(unlist(sixteenVillage4000_extInt_migRate_0.1))]
new3<-unlist(sixteenVillage4000_extInt_0.2)[!is.na(unlist(sixteenVillage4000_extInt_0.2))]
new4<-unlist(sixteenVillage4000_extInt_1)[!is.na(unlist(sixteenVillage4000_extInt_1))]
...
marker = list(color = brewer.pal(8,"YlOrRd"))
#plot smooth curves on top of each other
png(paste0(dir2,"extInt_dist_16x4000_comp_move.png"), width=1400, height=800, res=150) 
par(mfrow=c(1,2),mar=c(4,2,2,2),oma=c(3,4,3,3),mgp=c(3,1,0))
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,1),xlim=c(0,6),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
...
new_vec<-list(new,new1,new2,new3,new4)
num_cats = 5
png(paste0(dir2,"num_extInts_16x4000_comp_move_v2.png"), width=1400, height=800, res=150) 
for(i in 1:length(new_vec)){
  data = new_vec[[i]]
  sum_vec<-c()
  for(j in 1:num_cats){
  ...
  if(i == 1){
    plot(sum_vec,type='l',col=marker$color[i+2],lwd=2,xlab='Years since case',ylab='Number of extinction intervals')
  }
  else{
    lines(sum_vec,col=marker$color[i+2],lwd=2)
  }
...
new <- unlist(sixteenVillage4000_TBP)[!is.na(unlist(sixteenVillage4000_TBP))]
new1<-unlist(sixteenVillage4000_TBP_0.05)[!is.na(unlist(sixteenVillage4000_TBP_0.05))]
new2<-unlist(sixteenVillage4000_TBP_migRate_0.1)[!is.na(unlist(sixteenVillage4000_TBP_migRate_0.1))]
new3<-unlist(sixteenVillage4000_TBP_0.2)[!is.na(unlist(sixteenVillage4000_TBP_0.2))]
new4<-unlist(sixteenVillage4000_TBP_1)[!is.na(unlist(sixteenVillage4000_TBP_1))]
...
marker = list(color = brewer.pal(8,"YlOrRd"))
#plot smooth curves on top of each other
png(paste0(dir2,"interInt_dist_16x4000_comp_move.png"), width=1400, height=800, res=150) 
par(mfrow=c(1,2),mar=c(4,2,2,2),oma=c(3,4,3,3),mgp=c(3,1,0))
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,1),xlim=c(0,6),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
...
lines((k4$eval.points),k4$estimate,col=marker$color[7],lwd=2)
legend('topright',legend=c('Movement rate = 0','Movement rate = 0.05','Movement rate = 0.1','Movement rate = 0.2','Movement rate = 1'),col=marker$color[3:7],lwd=2,bty='n')
plot((k$eval.points),k$estimate,col=marker$color[3],type='l',ylim=c(0,0.0015),xlim=c(3,5),xlab='',ylab='',lwd=2)
lines((k1$eval.points),k1$estimate,col=marker$color[4],lwd=2)
lines((k2$eval.points),k2$estimate,col=marker$color[5],lwd=2)
lines((k3$eval.points),k3$estimate,col=marker$color[6],lwd=2)
lines((k4$eval.points),k4$estimate,col=marker$color[7],lwd=2)
...
new_vec<-list(new,new1,new2,new3,new4)
num_cats = 5
png(paste0(dir2,"num_interInts_16x4000_comp_move_v2.png"), width=1400, height=800, res=150) 
for(i in 1:length(new_vec)){
  data = new_vec[[i]]
  sum_vec<-c()
  for(j in 1:num_cats){
  ...
  if(i == 1){
    plot(sum_vec,type='l',col=marker$color[i+2],lwd=2,xlab='Years since case',ylab='Number of intercase intervals',ylim=c(0,1000))
  }
  else{
    lines(sum_vec,col=marker$color[i+2],lwd=2)
  }
