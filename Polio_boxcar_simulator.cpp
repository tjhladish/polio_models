...
int main(int argc, char** argv){
    ...
    Polio_boxcar_model model(0.02,numContacts*probInfection(1),numContacts*probInfection(10),numContacts*probInfection(100),numContacts*probInfection(1000),1/infectPeriod()[1],1/infectPeriod()[2],1/infectPeriod()[3],1/infectPeriod()[4],.003,.003,.003);
